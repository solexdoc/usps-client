...
{
    public const API_MODE_TEST = 1;
    public const API_MODE_STAGING = 2;
    public const API_MODE_PRODUCTION = 3;
    ...
    const STAGING_API_URL = 'https://stg-secure.shippingapis.com/ShippingApi.dll';
    /**
    ...
    public static int $apiMode = 1; //1 = Testing, 2= Staging, 3= Production
    /**
     * @var array - different kind of supported api calls by this wrapper
     */
    protected $apiCodes = [
        'eVS' => 'eVSRequest',
        'eVSCancel' => 'eVSCancelRequest',
    ...
    public function setApiMode(int $value){
        self::$apiMode = $value;
    }
    ...
    public function getEndpoint()
    {
        $urlToReturn = "";
        switch (self::$apiMode){
            case self::API_MODE_TEST:
                $urlToReturn = self::TEST_API_URL;
                break;
            case self::API_MODE_STAGING:
                $urlToReturn = self::STAGING_API_URL;
                break;
            case self::API_MODE_PRODUCTION:
                $urlToReturn = self::LIVE_API_URL;
                break;
        }
        return $urlToReturn;
    }
